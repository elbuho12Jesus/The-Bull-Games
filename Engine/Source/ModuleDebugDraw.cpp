...
void ModuleDebugDraw::Draw(const float4x4& view, const float4x4& proj, unsigned width, unsigned height)
{
    ...
    /*dd::line(ddVec3(0.0f, 0.5f, 0.0f), ddVec3(-0.5f, -0.5f, 0.5f), ddVec3(1.0f, 0.5f, 0.2f));
    dd::line(ddVec3(-0.5f, -0.5f, 0.5f), ddVec3(0.5f, -0.5f, 0.5f), ddVec3(1.0f, 0.5f, 0.2f));
    ...
    dd::line(ddVec3(0.0f, 0.5f, 0.0f), ddVec3(-0.5f, -0.5f, -0.5f), ddVec3(1.0f, 0.5f, 0.2f));
    dd::line(ddVec3(-0.5f, -0.5f, -0.5f), ddVec3(-0.5f, -0.5f, 0.5f), ddVec3(1.0f, 0.5f, 0.2f));
    dd::line(ddVec3(-0.5f, -0.5f, 0.5f), ddVec3(0.0f, 0.5f, 0.0f), ddVec3(1.0f, 0.5f, 0.2f));*/
